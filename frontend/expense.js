...
function showOnScreen(data) {
    ...
    const childNode = `<li id="${data.id}" >${data.Item} ${data.description} ${data.amount} <button style="margin-top: 10px;" class="btn btn-danger" onclick="deleteItem('${data.id}')" >delete expense</button></li>`
